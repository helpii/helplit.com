...
const Item = ({
  ...
  return (
    <li>
      <button
        className="relative flex gap-2 items-center w-auto py-2 px-4 my-2 text-base font-medium text-left md:text-lg bg-neutral rounded-lg"
        onClick={(e) => {
          e.preventDefault();
          setFeatureSelected();
        }}
      ...
      >
        <span className={`duration-100 ${isOpen ? 'text-accent' : ''}`}>
          {svg}
        </span>
        <span className={`flex-1 ${isOpen ? 'text-accent font-semibold' : ''}`}>
    ...
    >
      <div className="px-8">
        <h2 className="font-extrabold text-4xl lg:text-6xl tracking-tight mb-12 md:mb-24">
          ...
          <span className="bg-neutral px-2 md:px-4 ml-1 md:ml-1.5 leading-relaxed whitespace-nowrap text-accent">
            and get profitable
          </span>
        </h2>
